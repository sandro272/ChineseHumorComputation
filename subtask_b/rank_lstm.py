...
if __name__ == '__main__':
    ...
    # model.fit(X_train, y_train, validation_split=0.2, batch_size=batch_size, epochs=nb_epoch, verbose=2, callbacks=[checkpointer, early_stopping])
    model.fit(X_train, y_train, validation_data=[X_dev, y_dev], batch_size=batch_size, epochs=nb_epoch, verbose=2,)
    # model = load_model("weights.hdf5")

    model.save("weights_rank_lstm.hdf5")

...
def rank_bi_lstm_model(batch_size, nb_epoch, hidden_dim, num):
...
def rank_attention_lstm_model(batch_size, nb_epoch, hidden_dim, num):
...
def rank_stacked_lstm_model(batch_size, nb_epoch, hidden_dim, num):
...
if __name__ == '__main__':
    ...
    bi_lstm_pre1 = rank_bi_lstm_model(256, 25, 120, '1')
    bi_lstm_pre2 = rank_bi_lstm_model(256, 25, 120, '2')
    bi_lstm_pre3 = rank_bi_lstm_model(256, 25, 120, '3')
    bi_lstm_pre = (bi_lstm_pre1 + bi_lstm_pre2 + bi_lstm_pre3) / 3

    attention_pre1 = rank_attention_lstm_model(100, 30, 120, '1')
    attention_pre2 = rank_attention_lstm_model(100, 30, 120, '2')
    attention_pre3 = rank_attention_lstm_model(100, 30, 120, '3')
    attention_pre = (attention_pre1 + attention_pre2 + attention_pre3) / 3

    stacked_pre1 = rank_stacked_lstm_model(100, 22, 120, '1')
    stacked_pre2 = rank_stacked_lstm_model(100, 22, 120, '2')
    stacked_pre3 = rank_stacked_lstm_model(100, 22, 120, '3')
    stacked_pre = (stacked_pre1 + stacked_pre2 + stacked_pre3) / 3

    y_pre = (bi_lstm_pre + attention_pre + stacked_pre)

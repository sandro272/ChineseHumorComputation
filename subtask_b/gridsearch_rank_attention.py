...
def attention_lstm_model(r_dropout):
    ...
    enc = Bidirectional(GRU(hidden_dim // 2, recurrent_dropout=r_dropout, return_sequences=True))(embedded)
...
if __name__ == '__main__':
    ...
    # model = KerasClassifier(build_fn=attention_lstm_model, nb_epoch=24, batch_size=8, verbose=1)
    model = KerasClassifier(build_fn=attention_lstm_model, batch_size = 100, epochs = 30, verbose=1)
